        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-full h-full bg-pink-100 dark:bg-pink-900 rounded-xl"></div>
              <img
                src="GW7s2wZ2Esk.jpg"
                alt="Игорь Чудаков выступает"
                className="relative z-10 rounded-xl shadow-lg w-full h-auto object-cover"
              />
              <div className="absolute -bottom-4 -right-4 bg-peach-100 dark:bg-peach-900 p-4 rounded-lg shadow-md z-20">
          ...
          <div className="md:w-1/2">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-pink-50 dark:bg-pink-900 rounded-full text-pink-700 dark:text-pink-300 font-medium mb-6">
